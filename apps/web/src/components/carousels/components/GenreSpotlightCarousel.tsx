...
import { Carousel } from "../classic-carousel";
import { fetchDiscoverByGenres, fetchGenreList } from "../../../client/tmdb.js";
...
export function GenreSpotlightCarousel({
  media,
}: GenreSpotlightCarouselProps) {
