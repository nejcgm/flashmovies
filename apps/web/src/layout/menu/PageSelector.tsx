      ...
      >
        <div className=" max-w-[1000px] px-[24px] sm:mx-[64px] flex flex-col self-center w-full mt-[100px]">
          <div className="flex w-full justify-between items-center">
            <button
              onClick={() => {
                redirectForNavigation('home', ClickTypeEnum.NAVIGATION, incrementClick, isPro);
                navigate("/");
                handleClose();
              }}
            >
              ...
              <div className="flex gap-2 sm:gap-3">
                ...
                <div className="flex flex-col items-start gap-3">
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('popular_movies', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('now_playing', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('upcoming', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('browse_by_genre', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
              ...
              <div className="flex gap-2 sm:gap-3">
                ...
                <div className="flex flex-col items-start gap-3">
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('top_rated_tv', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('popular_tv', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('airing_today', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('on_air', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('browse_tv_genre', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
              ...
              <div className="flex gap-2 sm:gap-3">
                ...
                <div className="flex flex-col items-start gap-3">
                  ...
                  <a
                    ...
                    onClick={() => {
                      redirectForNavigation('popular_actors', ClickTypeEnum.MENU_LINK, incrementClick, isPro);
                      onCancel();
                    }}
                    className="hover:underline"
                  >
