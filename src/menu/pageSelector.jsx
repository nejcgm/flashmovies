                        ...
                        <div className='text-white font-roboto flex flex-col'>
                            <div className='flex gap-3'>
                                ...
                                <div className='flex flex-col items-start gap-3'>
                                    ...
                                    <a href='/listpopularcelebs?type=person&search=popular' onClick={() => { onCancel() }} className='hover:underline'>Most Popular Actors</a>
                                </div>
                            </div>
                        </div>
