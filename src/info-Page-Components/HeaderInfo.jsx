    ...
    <>
      ...
      <div className="font-roboto text-white">
        ...
        <div className="flex w-full mt-[24px] gap-2">
          ...
          >
            <img
              className="hidden lg:flex w-full flex-1  rounded-lg w-[72px]"
                  ...
                  <>
                    <div>
                      <svg
                        ...
                        className="group-hover:text-[#f5c518] text-white"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        role="presentation"
                      >
        ...
        <div className="w-full flex gap-4 md:w-[70%] mt-[24px]">
          <div className="flex lg:hidden">
            <img
              ...
              className=" w-full flex-1  rounded-lg min-w-[120px] w-[150px]"
              src={`https://image.tmdb.org/t/p/w500${poster}`}
              alt="poster"
            />
          </div>
