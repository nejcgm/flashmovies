...
import GenreListComponent from "../genre-list/GenreListComponent";
  ...
  return (
    <>
      <div className="w-full flex flex-col">
        <div className="flex flex-col w-[100%] sm:w-[70%] self-center gap-4 p-4 bg-[#101010] rounded-lg">
          <div className="font-roboto text-[#f5c518] text-[32px] mb-[16px] flex gap-3 font-semibold">
            <BackButton />
            {formatTitle(title)}
          </div>
